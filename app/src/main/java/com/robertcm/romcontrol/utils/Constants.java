...
public class Constants {
    ...
    public static final String SERVICE_INTENT_ACTION_BACKUP = "com.robertcm.action.BACKUP";
    public static final String SERVICE_INTENT_ACTION_RESTORE = "com.robertcm.action.RESTORE";
